...
export const ASSERTION_MODE_CATALOG: AssertionModeSpec[] = [
  ...
  },
  {
    ...
    label: "Not equals",
    group: "Text match",
    hint: "Output must NOT exactly match this string (trimmed) — promptfoo's not-equals.",
    needsValue: true,
    valuePlaceholder: "String the output must differ from",
    needsReference: false,
    needsThreshold: false,
  },
  {
  ...
  },
  {
    ...
    label: "Contains HTML",
    group: "Structured data",
    hint: "Output must contain at least one HTML tag — promptfoo's contains-html.",
    needsValue: false,
    needsReference: false,
    needsThreshold: false,
  },
