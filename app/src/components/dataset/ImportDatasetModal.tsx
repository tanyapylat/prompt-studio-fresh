...
export function ImportDatasetModal({
  ...
  return (
    <Modal title="Create dataset from file" onClose={onClose} width="lg">
          ...
          <>
            ...
            <div
              ...
              className={`flex cursor-pointer flex-col items-center gap-2 rounded-xl border-2 border-dashed px-6 py-10 text-center transition-colors ${
                dragging ? "border-sky-500 bg-sky-50" : "border-slate-300 hover:border-sky-400 hover:bg-slate-50"
              }`}
            >
                    ...
                    {table.headers.map((header, i) => (
                      <th key={i} className="border-b border-slate-200 px-2.5 py-2">
                        ...
                        <select
                          ...
                          className="w-full rounded-md border border-slate-200 bg-white px-1.5 py-1 text-[11px] text-slate-700 outline-none focus:border-sky-500"
                        >
