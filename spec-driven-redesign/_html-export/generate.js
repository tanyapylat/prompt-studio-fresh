...
const files = [
  "README.md",
  "01-concepts-and-entity-mapping.md",
  "02-workflow-starting-anew.md",
  "03-workflow-new-version-from-existing.md",
  "04-cross-cutting-ux-and-open-questions.md",
  "05-eval-methodology-best-practices.md",
  "06-sdd-alignment-and-resolutions.md",
];

// Render fenced ```mermaid blocks as <pre class="mermaid"> for client-side rendering,
// and rewrite in-repo .md links to .html so cross-navigation works in the exported set.
...
<body>
<div class="banner">Technical / engineering set — for the plain-language business-process companion, see <a href="../../process-playbook/_html-export/README.html">process-playbook</a>.</div>
<div class="nav">${files
  .map((f) => {
